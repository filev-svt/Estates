...
public static class DbInitializer
{
    public static void Initialize(StoreContext context)
    {
        ...
        var houseFaker = new Faker<House>()
            ...
            .RuleFor(house => house.Currency, f => f.Finance.Currency().Code)
            ...
            .RuleFor(house => house.Price, f => f.Random.Long(10000, 1000000))
            .RuleFor(house => house.InitialPrice, f => f.Random.Long(10000, 1000000))
